...
# st.set_option('deprecation.showfileUploaderEncoding', False)  # Remove or comment out this line
...
def main():
    ...
    consumer_secret = "nJAx7Kp8IDyW9hPL1wH41Bonp7tSNF1ChUjaMIgQMazsGnpEj"
